...
def normalize_answer(s):
    ...
    def remove_cn_punc(text: str) -> str:
        chinese_punctuation = re.compile(r'[，。、；：？！“”‘’『』「」《》〈〉（）【】——……·]')
        return chinese_punctuation.sub(' ', text)
    
    # def tokenize(text: str) -> str:
        # """
        # Add a Chinese word segmentation dictionary as needed, especially for traditional Chinese medicinal materials.
        # """
        # import jieba
